...
class EMP1 implements Employee {//implementation class
    public void Employee_details(){
        ...
        System.out.println("****************");
        System.out.println("Employee 1= Adarsh kasaudhan");
        System.out.println("Employee Salary=20k");
        System.out.println("Employee Location=bengaluru ");
        System.out.println("Employee company= Microsoft");
    }
}
...
class EMP2 implements Employee2 {//implementation class
    public void Employee_details2(){
        System.out.println("Employee Details");
        System.out.println("****************");
        System.out.println("Employee 2= ashif khan");
        System.out.println("Employee Salary=20k");
        System.out.println("Employee Location=bengaluru ");
        System.out.println("Employee company= TCS");
    }
}
...
class EMP3 implements Employee3 {//implementatiom class
    public void Employee_details3(){
        System.out.println("Employee Details");
        System.out.println("****************");
        System.out.println("Employee 3=Ashif raza ");
        System.out.println("Employee Salary=20k");
        System.out.println("Employee Location= bengaluru");
        System.out.println("Employee company= Galaghar");
    }
}
...
class EMP4 implements Employee4 {//implementation class
    public void Employee_details4(){
        System.out.println("Employee Details");
        System.out.println("****************");
        System.out.println("Employee 4= prem rajesh");
...
class EMP5 implements Employee5 {//implementation class
    public void Employee_details5(){
        System.out.println("Employee Details");
        System.out.println("****************");
        System.out.println("Employee 5= Prakhar kasaudhan");
        System.out.println("Employee Salary=30k");
        System.out.println("Employee Location= bengaluru");
        System.out.println("Employee company=Continental ");
    }
}
class employeeinter{
